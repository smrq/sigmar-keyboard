...
KC_LCTL,  KC_LALT,  KC_LGUI,  KC_LSFT,  MO_LOWR,  KC_SPC,                       KC_SPC,   MO_RAIS,  KC_RSFT,  KC_RGUI,  KC_RALT,  KC_RCTL
    ...
    [_LOWER] = LAYOUT(
_______,  KC_SLSH,  KC_7,     KC_8,     KC_9,     KC_ASTR,                      KC_CIRC,  KC_AMPR,  KC_PIPE,  KC_TILD,  KC_EXLM,  X(ENDASH),
...
_______,  _______,  _______,  _______,  _______,  KC_BSPC,                      KC_BSPC,  _______,  _______,  _______,  _______,  _______
    ...
    [_RAISE] = LAYOUT(
_______,  XXXXXXX,  KC_AMPR,  KC_ASTR,  XXXXXXX,  XXXXXXX,                      XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  X(EMDASH),
_______,  XXXXXXX,  KC_DLR,   KC_PERC,  KC_CIRC,  XXXXXXX,  _______,  _______,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
_______,  XXXXXXX,  KC_EXLM,  KC_AT,    KC_HASH,  XXXXXXX,  _______,  _______,  XXXXXXX,  XXXXXXX,  X(GUIL_L), X(GUIL_R), XXXXXXX,  _______,
...
_______,  _______,  _______,  _______,  _______,  _______,                      _______,  _______,  _______,  _______,  _______,  _______
    ...
    [_FN] = LAYOUT(
XXXXXXX,  XXXXXXX,  KC_F21,   KC_F22,   KC_F23,   KC_F24,                       KC_F9,    KC_F10,   KC_F11,   KC_F12,   XXXXXXX,  XXXXXXX,
KC_PAUS,  XXXXXXX,  KC_F17,   KC_F18,   KC_F19,   KC_F20,   XXXXXXX,  XXXXXXX,  KC_F5,    KC_F6,    KC_F7,    KC_F8,    XXXXXXX,  XXXXXXX,
_______,  XXXXXXX,  KC_F13,   KC_F14,   KC_F15,   KC_F16,   XXXXXXX,  XXXXXXX,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    XXXXXXX,  KC_PSCR,
