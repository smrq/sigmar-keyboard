...
#define CC_KILL LCTL(LALT(KC_DEL))
#define CC_SNIP LWIN(LSFT(KC_S))
#define CC_DSKL LWIN(LCTL(KC_LEFT))
#define CC_DSKR LWIN(LCTL(KC_RIGHT))
#define CC_DSKN LWIN(LCTL(KC_D))
#define CC_DSKX LWIN(LCTL(KC_F4))
...
KC_LCTL,  KC_LALT,  KC_LGUI,  KC_BSPC,  MO_LOWR,  KC_LSFT,                      KC_SPC,   MO_RAIS,  KC_RSFT,  KC_RGUI,  KC_RALT,  KC_RCTL
    ),
    [_LOWER] = LAYOUT(
...
_______,  _______,  _______,  XXXXXXX,  XXXXXXX,  _______,                      XXXXXXX,  XXXXXXX,  _______,  _______,  _______,  _______
    ...
    [_EXTRA] = LAYOUT(
_______,  XXXXXXX,  XXXXXXX,  CC_DSKN,  XXXXXXX,  RGB_HUI,                      XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_PAUS,  XXXXXXX,
CC_KILL,  XXXXXXX,  CC_DSKL,  CC_DSKX,  CC_DSKR,  XXXXXXX,  RGB_MOD,  RGB_TOG,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
